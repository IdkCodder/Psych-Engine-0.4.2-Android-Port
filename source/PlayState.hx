...
// STAGE SCRIPTS
		...
		*/
		...
		healthCounter = new FlxText(0, healthBarBG.y - 48, FlxG.width, "" , 20);
                healthCounter.setFormat(Paths.font("comic.ttf"), 19, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
